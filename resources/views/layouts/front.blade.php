    ...
    <head>
        ...
        <header id="header" class="fixed-top ">
            ...
            <a href="{{ url('/') }}" class="logo mr-auto">
                <img src="{{asset('assets/img/bemo-logo2.png')}}" width="165"  class="img-fluid"/>
            </a>
        ...
        <script src="{{ asset('assets/js/main.js')}}"></script>
         ...
         <!-- Global site tag (gtag.js) - Google Analytics -->
        <script async src="https://www.googletagmanager.com/gtag/js?id={{$global_settings->fb_ads_pixel}}"></script>
        <script>
